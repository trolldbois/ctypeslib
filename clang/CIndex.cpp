...
unsigned clang_getRecordSize(CXTranslationUnit TU, CXCursor cursor) {
...
unsigned clang_getRecordAlignment(CXTranslationUnit TU, CXCursor cursor) {
  assert(clang_isDeclaration(cursor.kind) && "isDeclaration == FALSE");
...
unsigned clang_getRecordFieldOffset(CXTranslationUnit TU, CXCursor cursor) {
  assert(clang_isDeclaration(cursor.kind) && "isDeclaration == FALSE");
