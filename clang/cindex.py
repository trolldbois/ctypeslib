...
_clang_getRecordSize = lib.clang_getRecordSize
_clang_getRecordSize.argtypes = [TranslationUnit, Cursor]
_clang_getRecordSize.restype = c_int

_clang_getRecordFieldOffset = lib.clang_getRecordFieldOffset
_clang_getRecordFieldOffset.argtypes = [TranslationUnit, Cursor]
_clang_getRecordFieldOffset.restype = c_int
###
